...
Here we introduce what might be seen as a semantics for [indeterminate](<https://en.wikipedia.org/wiki/Indeterminate_(variable)>)s. Indeterminates can be thought of as constants (not variables).
